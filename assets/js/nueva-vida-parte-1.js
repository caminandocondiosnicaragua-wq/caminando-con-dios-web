...
function renderExamen_(){
 const avatar=typeof obtenerAvatarComunidad==="function"?obtenerAvatarComunidad():null;
 const companion=avatar?'<aside class="nv1-avatar-companion nv1-avatar-right nv1-avatar-moving nv1-avatar-challenge" aria-label="Acompañamiento de '+escaparNV1_(avatar.nombre)+'"><div class="nv1-avatar-bubble"><strong>'+escaparNV1_(avatar.nombre)+' te anima...</strong><p>Lee con calma, piensa antes de elegir y usa lo que aprendiste en las citas bíblicas. Este reto es para comprobar cuánto comprendiste.</p></div><div class="nv1-avatar-figure"><img src="'+avatar.imagen+'" alt="'+escaparNV1_(avatar.nombre)+' animándote"></div></aside>':'';
 return `<section class="nv1-section nv1-final-section" id="nv1-examen" data-step="7">
 <div class="nv1-accessibility" aria-label="Herramientas de lectura">
   <span>Texto</span><button type="button" onclick="cambiarTamanoNV1_(-1)" aria-label="Reducir letra">A−</button><button type="button" onclick="cambiarTamanoNV1_(1)" aria-label="Aumentar letra">A+</button>
   <button type="button" class="nv1-audio-control" onclick="escucharSeccionNV1_(this)">🔊 Escuchar</button>
 </div>
 <span class="nv1-badge">Desafío final · modo juego</span>${companion}<h2>Reto de comprensión</h2><p class="nv1-section-intro">Ahora sí: una pequeña prueba con tiempo. El resultado queda guardado en tu recorrido para que puedas volver a verlo.</p><div class="nv1-game"><div class="nv1-game-top"><div><strong id="nv1-exam-counter">Pregunta 1 de ${NV1_EXAMEN.length}</strong><div class="nv1-game-note">No es una carrera contra otros. Es una oportunidad para ver cuánto has comprendido.</div></div><div id="nv1-timer" class="nv1-timer">05:00</div></div><div id="nv1-game-question" class="nv1-game-question"></div><div id="nv1-game-options" class="nv1-game-options"></div><div class="nv1-game-footer"><span id="nv1-game-feedback" class="nv1-game-note"></span><button id="nv1-game-next" class="nv1-btn nv1-btn-primary" onclick="siguientePreguntaNV1_()">Siguiente</button></div><div id="nv1-result" class="nv1-result" style="display:none"></div></div></section>`;
}

function renderCierre_(){
 const avatar=typeof obtenerAvatarComunidad==="function"?obtenerAvatarComunidad():null;
 const companion=avatar?'<aside class="nv1-avatar-companion nv1-avatar-right nv1-avatar-moving nv1-avatar-closing" aria-label="Acompañamiento de '+escaparNV1_(avatar.nombre)+'"><div class="nv1-avatar-bubble"><strong>'+escaparNV1_(avatar.nombre)+' te acompaña...</strong><p>Detente un momento, mira todo lo que has aprendido y escribe cómo quieres vivir esta nueva vida con Cristo.</p></div><div class="nv1-avatar-figure"><img src="'+avatar.imagen+'" alt="'+escaparNV1_(avatar.nombre)+' acompañando el cierre"></div></aside>':'';
 return `<section class="nv1-section nv1-reflection" data-step="8">
 <div class="nv1-accessibility" aria-label="Herramientas de lectura">
   <span>Texto</span><button type="button" onclick="cambiarTamanoNV1_(-1)" aria-label="Reducir letra">A−</button><button type="button" onclick="cambiarTamanoNV1_(1)" aria-label="Aumentar letra">A+</button>
   <button type="button" class="nv1-audio-control" onclick="escucharSeccionNV1_(this)">🔊 Escuchar</button>
 </div>
 <span class="nv1-badge">Para cerrar</span>${companion}<h2>No termina aquí</h2><p class="nv1-section-intro">El material invita a resumir lo aprendido y continuar creciendo. Tómate un momento para escribir tu propia respuesta.</p><div class="nv1-question"><div class="nv1-q-head"><div class="nv1-q-num">♥</div><div><h3>¿Cómo era mi vida sin Cristo?</h3></div></div><textarea class="nv1-answer" data-q="resumen1" placeholder="Escribe tu reflexión..."></textarea></div><div class="nv1-question"><div class="nv1-q-head"><div class="nv1-q-num">✝</div><div><h3>¿Qué hizo Cristo por mí?</h3></div></div><textarea class="nv1-answer" data-q="resumen2" placeholder="Escribe tu reflexión..."></textarea></div><div class="nv1-question"><div class="nv1-q-head"><div class="nv1-q-num">🌱</div><div><h3>¿Cómo se debe mostrar, en mi andar diario, la nueva vida que Dios me dio?</h3></div></div><textarea class="nv1-answer" data-q="resumen3" placeholder="Escribe tu reflexión..."></textarea></div><div class="nv1-question"><div class="nv1-q-head"><div class="nv1-q-num">📖</div><div><h3>Mi compromiso de crecimiento</h3><p class="nv1-section-intro">Esta semana el material propone leer Juan 1–7, un capítulo por día, y memorizar Efesios 2:8-9.</p></div></div><label class="nv1-choice"><input type="checkbox" id="nv1-compromiso"> Me comprometo a apartar tiempo para leer y orar.</label></div><div class="nv1-actions"><button class="nv1-btn nv1-btn-primary" onclick="guardarCierreNV1_()">Guardar mi cierre</button></div><div id="nv1-complete" class="nv1-complete"><h2>🌱 Has dado un paso más</h2><p>Tu avance quedó guardado en este dispositivo para tu cuenta. Puedes volver y continuar desde aquí.</p><div id="nv1-history" class="nv1-history"></div></div></section>`;
}
